...
| [REVIEW-v0.2.7.md](REVIEW-v0.2.7.md) | PR 合并后完整需求检视、端到端验证、修复和可用性结论 |
...
0.2.2 历史快照：[实现记录](IMPLEMENTATION_STATUS-v0.2.2.md)、[验证记录](VALIDATION-v0.2.2.md)。

0.2.3 历史快照：[实现记录](IMPLEMENTATION_STATUS-v0.2.3.md)、[验证记录](VALIDATION-v0.2.3.md)。
...
0.2.4 历史快照：[实现记录](IMPLEMENTATION_STATUS-v0.2.4.md)、[验证记录](VALIDATION-v0.2.4.md)。
